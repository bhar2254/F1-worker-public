...
export class Page extends Defaults {
    ...
    get navbar() {
        ...
        return `
            <nav class='navbar navbar-expand-lg bg-glass-dark bg-glass-dark-5 text-end bg-gradient sticky-top shadow-lg'>
                <div class='col-lg-6 col-md-9 col-sm-11 container-fluid'>
                <button class='ms-auto my-1 navbar-toggler' type='button' data-bs-toggle='collapse' data-bs-target='#navbarSupportedContent' aria-controls='navbarSupportedContent' aria-expanded='false' aria-label='Toggle navigation'><i class='fa-solid fa-bars'></i></button>
